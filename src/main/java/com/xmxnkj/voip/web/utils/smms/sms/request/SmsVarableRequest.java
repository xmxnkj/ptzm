 ...
 * 
 * @author tianyh 
 * @date 2017年4月15日 下午3:41:50
 * @Title: SmsVarableRequest
 * @ClassName: SmsVarableRequest
 * @Description:变量短信发送
 */
public class SmsVarableRequest {
	/**
	 * 用户账号，必填
	 */
	...
	public SmsVarableRequest() {
		
	}
	public SmsVarableRequest(String account, String password, String msg, String params) {
		super();
