...
public class YeepayService {
	...
	public static Map<String, String> queryByOrder (Map<String, String> params) throws UnsupportedEncodingException {
		...
		String hmac_safeFromYeepay		= "";
       	String hmacError		   		= ""; //�Զ��壬�ǽӿڷ��ء�
		String errorMsg					= ""; //�Զ��壬�ǽӿڷ��ء�
...
//				hmacError	= "Hmac ��ƥ�䣡 hmacFromYeepay : "
//							+ hmacFromYeepay 
//							+ "; localHmac : "
//							+ localHmac;
	...
	/**
	 * verifyCallbackHmac_safe() : ��֤�ص���ȫǩ������Ƿ���Ч
	 * @throws UnsupportedEncodingException 
	 */
