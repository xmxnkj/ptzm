...
<script src="../../content/scripts/format/easyuiExtend.js"></script>
...
<!-- <div class="pop" id="PerfectData" style="top:0%; width:400px; margin-left:-193px;"> -->
    ...
    <div class="main">
        ...
        <div class="Input">
        	...
        	<a href="#" class="button button-action button-pill button-small" onclick="check()" style="margin-left: 100px">保存</a>
      ...
      <form method="post" id="frm" style="width:85%; ">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb tb7">
            ...
            <tr>
                <th width="35%">电话号码</th>
                <td width="65%"><input class="easyui-textbox" validType='phoneNum' data-options="required:true,missingMessage:'请输入电话号码！'" name="mobile" id="mobile" style="width:90%;"></td>
            </tr>
           <tr>
                <th width="35%">计划状态</th>
                <td width="65%">
